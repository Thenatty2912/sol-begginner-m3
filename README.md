...
This is a simple Solidity smart contract that creates a token called "ELIXIR" with the abbreviation "EX". It has a total supply that starts at 0, and uses a mapping of addresses to balances to keep track of how many tokens each address holds.
...
This program is a simple contract written in remix. The contract allows you to mint and burn values to the account address.
...
I would like to thank the Remix Tutorials and the Remix website for making such wonderful tools for learning and developing smart contracts on the Ethereum network.
